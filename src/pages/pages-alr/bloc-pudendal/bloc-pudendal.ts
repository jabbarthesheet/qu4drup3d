...
/**
 * Generated class for the BlocPudendalPage page.
 *
...
@Component({
  selector: 'page-bloc-pudendal',
  templateUrl: 'bloc-pudendal.html',
})
export class BlocPudendalPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad BlocPudendalPage');
  };
