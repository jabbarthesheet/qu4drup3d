...
export class PlateauVasPage {
  ...
  calculs(){
      ...
      if(this.PoidsNum <= 10 && this.AgeNum <= 1){this.TailleFiltre = "néonat"}
      else if (this.AgeNum <= 72 && this.PoidsNum <= 20){this.TailleFiltre = "pédiatrique"}
      else {this.TailleFiltre = "adulte"};
      ...
      if(this.PoidsNum <= 10){ this.LameMcGrath = "lame 1";}
      else if (this.PoidsNum <= 30) {this.LameMcGrath = "lame 2";}
      else if (this.PoidsNum <= 70) {this.LameMcGrath = "lame 3";}
      else {this.LameMcGrath = "lame 4";};

      if (this.PoidsNum <= 1.5){ this.LameGlideScope = "manche 1-2, lame 0";}
      else if (this.PoidsNum <= 3.8){ this.LameGlideScope = "manche 1-2, lame 1";}
      else if (this.PoidsNum <= 10){ this.LameGlideScope = "manche 1-2, lame 2";}
      else if (this.PoidsNum <= 28){ this.LameGlideScope = "manche AVL 1-2, lame 2.5";}
      else if (this.PoidsNum <= 40 ) { this.LameGlideScope = "manche 3-4, lame 3";}
      else  { this.LameGlideScope = "manche 3-4, lame GVL 4";};
